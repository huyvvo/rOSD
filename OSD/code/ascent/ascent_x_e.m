function [x,e] = ascent_x_e(data_loader, x, e, e_candidate, ...
								            nu, tau, num_regions, num_iter, xrows)
% ASCENT_X_E
% [x,e] = ascent_x_e(data_loader, x, e, e_candidate, ...
%                    nu, tau, num_regions, num_iter, perm)
%
...
for i = 1:num_iter
  x = ascent_x(data_loader, x, e, e_candidate, nu, num_regions, xrows);
