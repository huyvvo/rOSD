...
imgset = 'voc_vgg16_cnn_03_20_1_05_with_roots';
small_imdb = false;
lite_imdb = true;
nu = 5;
tau = 10;
...
scname = 'vgg16_relu53_77_roi_pooling_noresize_01_symmetric';
normsc = true;
rounding = '1000';
iterating = '1000';
...
scname_nb = 'vgg16_relu53_77_roi_pooling_noresize_01_symmetric_50_neighbor_cos_vgg16_fc6_resize';
...
[args.iters{all_classes}] = deal(iters);
[args.ens_size{all_classes}] = deal(ens_size);
[args.num_nb_regions{all_classes}] = deal(num_nb_regions);

%--------------------------

[sol, corloc, detRate] = eval_solutions(args, 21);
